...
<Card style={{ width: '25rem', height: '20rem', marginBottom:'20px', marginTop:'-10%'}}>
     ...
     <Card style={{ width: '25rem',height: '20rem', marginLeft:'30px', marginBottom: '20px',marginTop:'-10%'}}>
     <Card.Body>
...
<Card style={{flexDirection:'row', width:'53rem', height:'30rem'}}>
        ...
        <h3 style={{marginLeft:'5%', marginTop:'5%'}}> Financial Data</h3>
       
     
<div>
    
</div>
        <h5 style={{marginLeft:'40%', marginTop:'5%'}} > Showing: <Select  options={options}  /></h5>
...
<Row>
       <Card style={{marginTop:'30%', width:'19rem', marginLeft:'40%'}}>
       <Card.Body>
         ...
         <Card.Text>
            ...
            <Card style={{marginTop:'10%', width:'19rem', marginLeft:'40%'}}>
       <Card.Body>
    ...
    <Col>
    <Row>
            <Card style={{marginTop:'30%', width:'19rem', marginLeft:'20%'}}>
       <Card.Body>
         ...
         <Card.Text>
            ...
            <Card style={{marginTop:'10%', width:'19rem', marginLeft:'20%'}}>
       <Card.Body>
